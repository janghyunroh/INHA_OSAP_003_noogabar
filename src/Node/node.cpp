...
template <typename T1, typename T2> T2 getdata() { return this->data_; }

template <typename T1, typename T2> Node<T1, T2> *getleft() { return this->left_; }

template <typename T1, typename T2> void setleft(Node<T1, T2> *node) {
  this->left = node;
}

template <typename T1, typename T2> Node<T1, T2> *getright() { return this->right_; }
